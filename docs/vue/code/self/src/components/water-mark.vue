...
export default {
  data() {
    return {
      defaultimg: 'https://sf1-ttcdn-tos.pstatp.com/img/motor-img/7218414812ab0679740470d8aebbdd47~noop.image',
      preImg: "",
      watermarkOptions: {
        text: "仅供 xxx 验证使用",
        fontSize: 10,
  ...
  mounted() {
    ...
    // to write to a file...
    GifUtil.write("https://sf1-ttcdn-tos.pstatp.com/img/motor-img/7218414812ab0679740470d8aebbdd47~noop.image", frames, { loops: 3 }).then(gif => {
        console.log("written");
    });
